...
def _require_instagram_config(
    ...
    if not access_token:
        raise InstagramError("Missing INSTAGRAM_ACCESS_TOKEN")
    if not instagram_account_id:
        raise InstagramError("Missing INSTAGRAM_ACCOUNT_ID")
...
def create_image_container(
    ...
    instagram_account_id = instagram_account_id or settings.INSTAGRAM_ACCOUNT_ID
